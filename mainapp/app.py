...
def buat_pesanan():
    ...
    tgl_berangkat_str = str(request.form['tgl_berangkat'])
    tgl_berangkat = datetime.strptime(tgl_berangkat_str, '%Y-%m-%d').date()

    no_hp = str(request.form['no_hp'])
    harga = int(request.form['harga'])

    if not (nama and email and jml_tiket and tgl_berangkat and no_hp and harga):
    ...
    data = {
        ...
        'email': email,
        'jml_tiket': jml_tiket,
        'tgl_berangkat': tgl_berangkat.strftime('%Y-%m-%d'),
        'no_hp': no_hp,
        'harga': harga
    }
